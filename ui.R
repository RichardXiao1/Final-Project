...
ui <- dashboardPage(skin = "blue",
                    ...
                    dashboardBody(
                      ...
                      tabItem(tabName = "measles",
                              fluidRow(
                                h1("Definition"),
                                h4("Measles stats"),
                                plotOutput("measlesPlot"),
                                tableOutput("measlesTable")
                              )
                      ),
                      tabItem(tabName = "polio",
                              fluidRow(
                                h1("Definition"),
                                h4("Polio stats"),
                                plotOutput("polioPlot"),
                                tableOutput("polioTable")
                              )
                      ),
                      
                      tabItem(tabName = "HIV/Aids",
                              fluidRow(
                                h1("Definition"),
                                h4("HIV stats"),
                                plotOutput("HIVPlot"),
                                tableOutput("HIVTable")
                              )
                      ),
                      tabItem(tabName = "Hepatitis",
                              fluidRow(
                                h1("Definition"),
                                h4("Hepatitis stats"),
                                plotOutput("hepatitisPlot"),
                                tableOutput("hepatitisTable")
                              )
                      ),
